    ...
    <body>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="ordermanager" data-menu="order"><i class='app-menu__icon bx bx-credit-card-front'></i>
                        <span class="app-menu__label">
                            Quản lý đơn hàng  
                        </span>
                    </a>
                ...
                <li>
                    <a class="app-menu__item" href="schedule" data-menu="log"><i class='app-menu__icon bx bxs-notepad'></i>
                        <span class="app-menu__label">
                            Xếp lịch nhân viên
                         </span>
                    </a>
